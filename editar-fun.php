		...
		<div class="container-login100">
			<div class="wrap-login100">
					...
					<div class="wrap-input100 validate-input" data-validate = "Informe o nome do funcionario !">
                                            <input class="input100" value="<?php print $row->nome; ?>" type="text" name="nome" placeholder="Nome">
					</div>
                                        <div class="tela">                                     
                                            <h6>CPF:</h6>
					</div>
                                        <div class="wrap-input100 validate-input" data-validate = "Informe o CPF !">
						<input class="input100" value="<?php print $row->cpf; ?>" type="number" name="cpf" placeholder="CPF">
					</div>
                                        <div class="tela">                                     
                                            <h6>TELEFONE:</h6>
					</div>
                                        <div class="wrap-input100 validate-input" data-validate = "Informe o celular !">
						<input class="input100" value="<?php print $row->telefone; ?>" type="tel" name="telefone" placeholder="Telefone">
					</div>
                                        <div class="tela">                                     
                                            <h6>PIS:</h6>
					</div>
                                        <div class="wrap-input100 validate-input" data-validate = "Informe o PIS da carteira de trabalho !">
						<input class="input100" value="<?php print $row->pis; ?>" type="number" name="pis" placeholder="PIS">
					</div>
                                        <div class="tela">                                     
                                            <h6>CARGO:</h6>
					</div>
                                        <div class="wrap-input100 validate-input" data-validate = "Informe seu Cargo !">
						<input class="input100" value="<?php print $row->cargo; ?>" type="text" name="cargo" placeholder="Cargo">
					</div>
                                        <div class="tela">                                     
                                            <h6>DATA DE NASCIMENTO:</h6>
					</div>
                                        <div class="wrap-input100 validate-input" data-validate = "Informe sua Data de Nascimento !">
						<input class="input100" value="<?php print $row->data_nasc; ?>" type="date" name="data_nasc" placeholder="Data de Nascimento">
					</div>
                                        <div class="tela">                                     
                                            <h6>SALARIO:</h6>
					</div>
                                        <div class="wrap-input100 validate-input" data-validate = "Informe Seu Salario !">
						<input class="input100" value="<?php print $row->salario; ?>" type="number" name="salario" placeholder="Salario">
					</div>
